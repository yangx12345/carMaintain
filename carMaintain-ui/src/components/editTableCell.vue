...
<div class="editable-cell">
    ...
    <div v-else class="editable-cell-text-wrapper" style="width:100%">
        ...
        <edit-outlined class="editable-cell-icon" style="color:#1890ff;margin-left:10px;display:inline" v-if="itemConfig.config.isEdit" @click="edit" />
    </div>
</div>
</template>
