        ...
        tableMessage: {
          ...
          tableData: [
            ...
            },
            {
              ...
              ellipsis:true,
              required: true,
              dataIndex: 'redpacketactivity_id',
              width:120,
              config: {
                type: 'text',
              },
              slots: {
                customRender: 'redpacketactivity_id',
              },
            },
            {
              align:'center',
            ...
            },
            {
              ...
              config: {
                ...
                size: 'default',
                buttonBg: 'green',
                enumType: 'audit_state',
                defaultValue: 1,
                value: '',
              },
              slots: {
                customRender: 'audit_state',
              },
            },
            {
              align:'center',
