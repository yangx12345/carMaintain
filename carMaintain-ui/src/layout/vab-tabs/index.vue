...
<div class="vab-tabs" id="vabTabs" style="align-items:center;display: flex;">
    ...
    <div id="rightItem"  style="position: fixed;right:20px;display: flex;align-items: center;">
        ...
        <a-button class="tabRightButton" @click="()=>showPacket=true" v-if="userInfo.red_packet_url">
            通用二维码
        </a-button>
        <a-button class="tabRightButton" @click="()=>$router.push({name:'readme'})">
            协议文档
        </a-button>
        <vab-avatar />
    </div>
...
export default {
    ...
    methods: {
        ...
        computeWidth(){
            ...
            this.vabTabs = vabTabs- 300 - 200 - 80
            if(!this.collapse){
                this.vabTabs -=100;
            }
